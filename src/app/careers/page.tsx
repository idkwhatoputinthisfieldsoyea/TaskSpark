...
export default function Careers() {
  return (
    <div className="min-h-screen bg-white text-slate-900">
      {/* Navigation Bar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white backdrop-blur-md border-b border-slate-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link
                href="/careers"
                className="text-slate-900 px-3 py-2 rounded-md text-sm font-medium bg-slate-100"
              >
                Careers
              </Link>
              <Link
                href="/about-team"
                className="text-slate-600 hover:text-slate-900 px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 hover:bg-slate-100"
              >
                About the Team
              </Link>
              <Link
            ...
            <div className="md:hidden">
              <button
                type="button"
                className="text-slate-600 hover:text-slate-900 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-300"
                aria-expanded="false"
              >
        ...
        <div className="md:hidden hidden bg-white border-t border-slate-200">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link
              href="/careers"
              className="text-slate-900 block px-3 py-2 rounded-md text-base font-medium bg-slate-100"
            >
              Careers
            </Link>
            <Link
              href="/about-team"
              className="text-slate-600 hover:text-slate-900 block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-100"
            >
              About the Team
            </Link>
            <Link
